...
/*   Updated: 2018/01/16 19:21:24 by jnederlo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form( void ) : _sign_grade(1), _exec_grade(1){
...
const char* Form::GradeTooHighException::what() const throw() {
    ...
    return "Sign/Exec grade set too high";
}
...
const char* Form::GradeTooLowException::what() const throw() {
    ...
    return "Sign/Exec grade set too low";
}
